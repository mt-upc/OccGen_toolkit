...
#todo: make it argument or take care to change
CORENLP_PATH = '/home/usuaris/veu/christine.raouf.saad/Ge-Bio-Balanced/stanford-corenlp-4.3.1/*'
...
class CoreNLPTokenizer(Tokenizer):
    ...
    def _launch(self):
        ...
        cmd = ['java', '-mx' + self.mem, '-cp', '"%s"' % self.classpath,
               # 'edu.stanford.nlp.pipeline.StanfordCoreNLP','-annotators',
               'edu.stanford.nlp.pipeline.StanfordCoreNLP', '-props', 'StanfordCoreNLP-arabic.properties',
               '-annotators',
...
if __name__ == '__main__':
    ...
    print(text)
    print(corenlp_ssplitter(tok, text))
    assert " ".join(corenlp_ssplitter(tok, text)) == text
